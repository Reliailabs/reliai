...
export async function getSettingsSurfaceData(organizationId: string | null): Promise<SettingsSurfaceData> {
  ...
  return {
    ...
    integrations: [
      ...
      { id: "slack", name: "Slack", connected: false, icon: "S", statusLabel: "Planned", href: "/settings#integrations" },
      { id: "pagerduty", name: "PagerDuty", connected: false, icon: "PD", statusLabel: "Planned", href: "/settings#alerts" },
      { id: "github", name: "GitHub", connected: false, icon: "GH", statusLabel: "Planned", href: "/settings#integrations" },
    ],
