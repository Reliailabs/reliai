  ...
  return (
    ...
    >
      <section className="grid gap-4 md:grid-cols-3">
        <Link href="/system/platform" className="rounded-2xl border border-border bg-card p-5 hover:bg-muted/30">
        ...
        <Link href="/system/pipeline" className="rounded-2xl border border-border bg-card p-5 hover:bg-muted/30">
          <div className="flex items-center justify-between">
        ...
        <Link href="/system/extensions" className="rounded-2xl border border-border bg-card p-5 hover:bg-muted/30">
          <div className="flex items-center justify-between">
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-border bg-card p-5">
          ...
          <p className="mt-1 text-xs text-muted-foreground">Planned parity wiring for customer expansion and tenant growth surfaces.</p>
          <div className="mt-3 flex flex-wrap gap-2 text-xs">
            <Link href="/system/customers" className="rounded-full border border-border px-3 py-1 hover:bg-muted/30">Customers</Link>
            <Link href="/system/growth" className="rounded-full border border-border px-3 py-1 hover:bg-muted/30">Growth</Link>
            <Link href="/system/expansion" className="rounded-full border border-border px-3 py-1 hover:bg-muted/30">Expansion</Link>
          </div>
        </div>
        <div className="rounded-2xl border border-border bg-card p-5">
          <p className="text-sm font-semibold text-foreground">Reliability Intelligence</p>
          <p className="mt-1 text-xs text-muted-foreground">Reserved for operational intelligence layer after system parity gap review.</p>
          <div className="mt-3 flex flex-wrap gap-2 text-xs">
            <Link href="/system/reliability-patterns" className="rounded-full border border-border px-3 py-1 hover:bg-muted/30">Reliability</Link>
            <Link href="/system/intelligence" className="rounded-full border border-border px-3 py-1 hover:bg-muted/30">Intelligence</Link>
          </div>
        </div>
      </section>
    </SystemLayoutShell>
