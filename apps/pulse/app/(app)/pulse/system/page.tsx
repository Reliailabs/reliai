    ...
    >
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-border bg-card p-5">
          ...
          <p className="mt-1 text-xs text-muted-foreground">Customer expansion and tenant growth telemetry across system-wide reliability surfaces.</p>
        ...
        <div className="rounded-2xl border border-border bg-card p-5">
          ...
          <p className="mt-1 text-xs text-muted-foreground">Operational intelligence feed for reliability patterns, guardrail recommendations, and global regressions.</p>
          <div className="mt-3 flex flex-wrap gap-2 text-xs">
