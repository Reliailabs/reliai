...
export default function SignupShimPage({ searchParams }: SignupShimPageProps) {
  ...
  const destinationLabel = isExternal ? "Reliai signup" : "Reliai sign-in";

  return (
    <main className="min-h-screen bg-[#09090B] text-zinc-100">
      <div className="mx-auto flex min-h-screen max-w-2xl flex-col items-center justify-center px-6 py-16">
        <div className="w-full rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
