...
const carouselCards = [
  ...
  {
    id: 4,
    category: "Suggested monitoring",
    title: "Turn findings into actionable reliability follow-ups",
    icon: ArrowRight,
    mockup: "asks",
  },
  {
    ...
    <div className="flex items-center justify-center h-full">
      <div className="relative w-32 h-56 bg-zinc-900 rounded-2xl border border-zinc-700 overflow-hidden">
        ...
        <div className="mt-6 px-3">
          <div className="text-[10px] text-zinc-400 mb-2">Signal Feed</div>
  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="bg-zinc-800/50 rounded-lg px-4 py-2 border border-zinc-700/50">
        <span className="text-xs font-mono text-zinc-400">RELIAI API</span>
      </div>
    </div>
  )
}
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
          <div className="lg:max-w-xl">
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-sm text-zinc-400">Reliability workflows and integrations</span>
          ...
          <p className="text-zinc-400 lg:max-w-sm lg:pt-12">
            Unify incidents, traces, audits, and deployment signals so teams can act on reliability risk quickly.
          </p>
        </div>
