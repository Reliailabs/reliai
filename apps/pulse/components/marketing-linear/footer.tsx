export function Footer() {
  const footerLinks = {
    Product: ["Pulse", "Audits", "Incidents", "Traces", "Guardrails", "Deployments"],
    Reliability: ["AREI", "Regression detections", "Failed evals", "High-risk outputs", "Timeline"],
    Company: ["About", "Careers", "Security", "Privacy", "Terms"],
    Resources: ["Documentation", "API", "Status", "Support"],
    Connect: ["Contact", "Community", "GitHub", "X (Twitter)"],
  }
