        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {riskTypes.map((risk, index) => (
            ...
            >
              ...
              <p className="text-zinc-500 text-sm leading-relaxed flex-1">{risk.description}</p>
      ...
      <MarketingSection>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 transition-colors rounded-2xl p-8 h-full flex flex-col gap-3"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.3 }}
            className="bg-zinc-900/50 border border-zinc-600 hover:border-zinc-500 transition-colors rounded-2xl p-8 h-full flex flex-col gap-3"
          >
