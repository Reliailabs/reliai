    ...
    <section className="relative py-40 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-zinc-400 text-sm">Reliability planning and governance</span>
        ...
        >
          Understand reliability trajectory
        </h2>

        {/* Description */}
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">Align your team around a shared reliability timeline.</span> Track incidents, regressions, and releases with high-signal operational context.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          {/* Left column - Coordinate remediation end-to-end */}
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Coordinate remediation end-to-end</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Consolidate findings, evidence, remediation, and certification context in one operational workspace.
            </p>
          ...
          <div className="border-r border-zinc-800 pt-16 pr-10 pb-16 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-zinc-500">Operator command palette</span>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 overflow-hidden">
              ...
              <div className="p-5">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                  Capture remediation notes and collaborate on{" "}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-16">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-zinc-200 font-medium">Incidents</span>
            </div>
            <p className="text-zinc-500 text-sm leading-relaxed">Coordinate strategic reliability work.</p>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-zinc-200 font-medium">Cross-team reliability programs</span>
            </div>
          ...
          <div>
            ...
            <p className="text-zinc-500 text-sm leading-relaxed">Break remediation into concrete execution phases.</p>
          </div>
