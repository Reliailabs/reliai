    ...
    >
      ...
      >
        ...
        <div className="p-3 border-b border-zinc-800/50">
          <div className="flex items-center gap-2 px-2 py-1.5">
            ...
            <span className="text-white font-semibold text-sm">Reliai</span>
        ...
        <div className="px-3 space-y-0.5">
          <NavItem icon={Inbox} label="Signal Feed" badge={3} active />
          <NavItem icon={CircleUser} label="My Signals" />
        </div>
        ...
        <div className="mt-5 px-3">
          ...
          <div className="space-y-0.5 mt-1">
            <NavItem icon={Layers} label="Incidents" hasSubmenu />
            <NavItem icon={FolderKanban} label="Audits" hasSubmenu />
            <NavItem icon={LayoutGrid} label="Traces" hasSubmenu />
            <NavItem icon={Users} label="Systems" hasSubmenu />
          </div>
        </div>
        ...
        <div className="mt-5 px-3">
          ...
          <div className="space-y-0.5 mt-1">
            ...
            <NavItem icon={Map} label="Risk Timeline" color="text-orange-400" />
            <NavItem icon={FileText} label="Guardrails" color="text-emerald-400" />
          </div>
        </div>
        ...
        <div className="mt-5 px-3 flex-1">
          ...
          <div className="space-y-0.5 mt-1">
            <NavItem icon={Sparkles} label="Production" hasSubmenu />
            <NavItem icon={Settings} label="Reliability" hasSubmenu />
          </div>
        </div>

        {/* Bottom */}
        <div className="p-3 border-t border-zinc-800/50">
          <NavItem icon={HelpCircle} label="Reliability Help" />
        </div>
      </motion.div>
      ...
      >
        <div className="px-4 py-3 border-b border-zinc-800/50 flex items-center justify-between">
          <h3 className="text-white font-semibold text-sm">Signal Feed</h3>
        ...
        <div className="flex-1 overflow-auto scrollbar-hide">
          <SignalFeedItem
            id="ENG-135"
            title="Failed eval spike after release"
          ...
          <SignalFeedItem
            id="LLM"
            title="LLM Chatbot"
            subtitle="New reliability update by raissa"
            time="1d"
          ...
          <SignalFeedItem
            id="ENG-159"
            title="Unsafe output in payment flow"
            subtitle="Guardrail threshold exceeded"
            time="2d"
          ...
          />
          <SignalFeedItem
            title="Agent routing regression investigation"
            subtitle="Added as investigation reviewer"
          ...
          />
          <SignalFeedItem
            title="RAG retrieval drift review"
            subtitle="New reliability update by paco"
      ...
      <motion.div className="flex-1 h-full bg-zinc-950 flex flex-col overflow-hidden" variants={panelVariants}>
        ...
        <div className="px-5 py-3 border-b border-zinc-800/50 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-1.5 text-xs">
            ...
            <span className="text-emerald-400">Payment assistant</span>
            <span className="text-zinc-600">›</span>
        ...
        <div className="flex-1 p-5 overflow-auto scrollbar-hide">
          <h2 className="text-white text-xl font-semibold mb-5">Failed eval spike after release</h2>
          ...
          <div className="bg-zinc-900/80 rounded-lg p-4 text-[11px] font-mono mb-5 border border-zinc-800/50">
            <div className="space-y-2">
              <div>
                ...
                <span className="text-amber-300">traceEvidence</span>
