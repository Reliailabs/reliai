        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {tiers.map((tier, index) => (
            <motion.div
              ...
              className="bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 transition-colors rounded-2xl p-8 h-full flex flex-col gap-4"
            >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <a
              ...
              className="px-5 py-2.5 bg-white text-zinc-900 font-medium rounded-lg hover:bg-zinc-100 transition-colors text-sm"
            >
              Walk through mitigation response
            </a>
          </div>
        </div>
      </MarketingSection>
