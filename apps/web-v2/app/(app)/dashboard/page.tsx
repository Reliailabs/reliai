...
import { incidents, changes, weeklyIncidents } from "@/lib/mock-data"

const openIncidents = incidents.filter((i) => i.status !== "resolved")
const unacknowledged = incidents.filter((i) => i.status === "open")
...
const maxIncidents = Math.max(...weeklyIncidents.map((d) => d.count))
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
            ...
            <div className="px-4 py-3 space-y-2.5">
              ...
              <StatusRow
                ...
                tone={unacknowledged.length > 0 ? "warning" : "success"}
              />
            </div>
          </div>
