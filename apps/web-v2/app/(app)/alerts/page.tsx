...
const alerts = [
  ...
  },
  {
    ...
    description: "Monthly cost budget exceeded by 12%",
    severity: "info" as const,
    status: "resolved" as const,
    project: "sentiment-analyzer",
    timestamp: "2024-01-14T16:20:00Z",
    duration: "3h 30m",
    affected: "$2,340 budget",
  },
  {
    id: "a4",
    title: "Model Drift Detected",
    description: "Output distribution changed significantly",
    severity: "warning" as const,
    status: "acknowledged" as const,
    project: "sentiment-analyzer",
    timestamp: "2024-01-14T14:10:00Z",
    duration: "1h 20m",
    affected: "Model v0.9.3",
  },
  {
    id: "a5",
    title: "Refusal Rate Spike",
    description: "Refusal rate increased by 300% in last hour",
    severity: "critical" as const,
    status: "active" as const,
    project: "sentiment-analyzer",
    timestamp: "2024-01-15T11:00:00Z",
    duration: "1h 5m",
    affected: "45 requests",
  },
]
      ...
      <div className="border border-zinc-800 rounded-lg overflow-hidden">
        <div className="bg-zinc-900/50 border-b border-zinc-800 px-6 py-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-medium text-zinc-200">Active Alerts</h3>
