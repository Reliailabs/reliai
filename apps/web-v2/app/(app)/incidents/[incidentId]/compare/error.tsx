...
export default function TraceCompareError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-full flex items-center justify-center px-6 py-12">
      <div className="max-w-md w-full rounded-lg border border-zinc-800 bg-zinc-900/60 p-8 text-center">
        <div className="text-xs uppercase tracking-[0.24em] text-zinc-500">Trace Compare</div>
        <h2 className="mt-3 text-lg font-semibold text-zinc-100">Unable to load trace comparison</h2>
