        ...
        <aside className="space-y-6 bg-transparent">
          <div className="rounded-2xl border border-line px-4 py-4">
            ...
            <div className="mt-4 space-y-3">
              <div className="rounded-lg border border-line px-3 py-2 text-sm text-secondary">
            ...
            <div className="mt-4 space-y-3">
              {legend.map((item) => {
                ...
                return (
                  <div
                    key={item}
                    className={`flex items-center gap-3 rounded-lg border border-line px-3 py-2 text-sm ${spanTone(item)}`}
                  >
