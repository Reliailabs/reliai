...
import { devAuthEnabled } from "@/lib/constants";
    ...
    <main className="flex min-h-screen items-center justify-center bg-[#f3f4f6] px-6">
      <Card className="w-full max-w-md p-8">
        ...
        <p className="mt-3 text-sm leading-6 text-steel">
          Production authentication now runs through WorkOS. Local development can still use the
          seeded fallback account when dev auth is enabled.
        </p>
        {workosSignInUrl ? (
          <a
