    ...
    <main className="bg-[#f7f8fa] text-ink">
      <section className={`border-b border-zinc-200 ${marketingSectionLargeClass}`}>
        <div className={`${marketingContainerClass} grid gap-12 pb-16 pt-20 lg:grid-cols-[1.1fr_0.9fr]`}>
          <div>
            <p className="text-xs uppercase tracking-[0.4em] text-steel">AI Reliability Audit</p>
            ...
            <div className="mt-4">
              <p className="text-sm text-steel">For teams already running LLMs in production.</p>
            </div>
            <div className="mt-8 flex flex-wrap items-center gap-4">
              ...
              <p className="text-xs uppercase tracking-[0.32em] text-steel">Powered by early Reliai infrastructure</p>
            </div>
            <div className="mt-6 rounded-2xl border border-accent/30 bg-white px-5 py-4 text-sm font-medium text-ink shadow-sm">
          ...
          <div className="rounded-[28px] border border-zinc-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
            <p className="text-xs uppercase tracking-[0.32em] text-steel">Engagement snapshot</p>
            <div className="mt-6 space-y-6">
              <div>
                <p className={`text-4xl text-ink ${marketingMetricClass}`}>7 days</p>
                <p className="mt-2 text-sm text-steel">Instrument, analyze, and harden your system.</p>
              </div>
              <div>
                <p className={`text-3xl text-ink ${marketingMetricClass}`}>3–5 failure modes</p>
                <p className="mt-2 text-sm text-steel">Documented issues with evidence, impact, and remediation paths.</p>
              </div>
              <div>
                <p className={`text-3xl text-ink ${marketingMetricClass}`}>Guardrails live</p>
                <p className="mt-2 text-sm text-steel">Validation, retries, and alerts in place before handoff.</p>
              </div>
            </div>
            <div className="mt-6 rounded-2xl border border-zinc-200 bg-[#0b0f14] px-5 py-4 text-xs text-zinc-200 shadow-[inset_0_0_0_1px_rgba(148,163,184,0.08)]">
            ...
            <div className="mt-8 rounded-2xl border border-zinc-200 bg-zinc-50 px-5 py-4 text-xs text-steel">
      ...
      <section className={`${marketingContainerClass} ${marketingSectionClass}`}>
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            <p className="text-xs uppercase tracking-[0.36em] text-steel">The risk</p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {risks.map((risk) => (
              <div key={risk.title} className={marketingCardClass}>
                ...
                <h3 className="mt-4 text-lg font-semibold text-ink">{risk.title}</h3>
                <p className="mt-2 text-sm leading-6 text-steel">{risk.description}</p>
                <p className="mt-3 text-xs font-semibold uppercase tracking-[0.24em] text-steel">{risk.impact}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className={`${marketingContainerClass} ${marketingSectionClass}`}>
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.36em] text-steel">What you get</p>
            <h2 className="mt-4 text-3xl font-semibold text-ink">A reliability upgrade, delivered in one week.</h2>
          </div>
            ...
            <div key={item.title} className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-steel">{item.benefit}</p>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className={`${marketingContainerClass} ${marketingSectionClass}`}>
        <div className="rounded-[28px] border border-zinc-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.36em] text-steel">How it works</p>
              <h2 className="mt-4 text-3xl font-semibold text-ink">Instrument. Analyze. Harden.</h2>
            </div>
            <p className="max-w-md text-sm leading-7 text-steel">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {steps.map((step, index) => (
              <div key={step.title} className="rounded-2xl border border-zinc-200 bg-zinc-50 p-6">
                <div className="flex items-center justify-between text-xs uppercase tracking-[0.32em] text-steel">
                  <span>Step {index + 1}</span>
                  <step.icon className="h-4 w-4 text-ink" />
                </div>
      ...
      <section className={`${marketingContainerClass} ${marketingSectionClass}`}>
        <div className="rounded-[28px] border border-accent/40 bg-white px-8 py-10 shadow-[0_20px_60px_rgba(185,28,28,0.12)]">
          <p className="text-xs uppercase tracking-[0.36em] text-steel">Guarantee</p>
          <h2 className="mt-4 text-3xl font-semibold text-ink">If we do not find meaningful issues, you do not pay.</h2>
      ...
      <section className={`${marketingContainerClass} ${marketingSectionClass}`}>
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-[24px] border border-zinc-200 bg-white p-8 shadow-sm">
            <p className="text-xs uppercase tracking-[0.36em] text-steel">Pricing</p>
            <h2 className="mt-4 text-3xl font-semibold text-ink">Typical engagement: $8k–$12k</h2>
            <p className="mt-4 text-sm leading-7 text-steel">
          ...
          <div className="rounded-[24px] border border-accent/40 bg-zinc-50 p-8 shadow-[0_18px_40px_rgba(185,28,28,0.12)]">
            ...
            <h3 className="mt-4 text-2xl font-semibold text-ink">Limited early-stage slots at $5k</h3>
            <p className="mt-4 text-sm leading-7 text-steel">
      ...
      <section className={`${marketingContainerClass} ${marketingSectionClass} pb-24`}>
        <div className="rounded-[28px] border border-zinc-200 bg-white px-8 py-12 shadow-[0_26px_70px_rgba(15,23,42,0.1)]">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.36em] text-steel">Ready for a reliability reset?</p>
              <h2 className="mt-4 text-3xl font-semibold text-ink">Book a 20-minute call to scope the audit.</h2>
              <p className="mt-3 text-sm leading-7 text-steel">
