...
<LimitStateExample
  message="Processing delayed — queued records await analysis"
  detail="High validation error volume can delay Reliai's pattern detection"
/>
...
- **Connect your system:** [/docs/getting-started/structured-output](/docs/getting-started/structured-output)
