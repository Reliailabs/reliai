...
const navItems: { label: string; href: string; group?: string }[] = [
  ...
  { label: "RAG Quickstart", href: "/docs/getting-started/rag", group: "getting-started" },
  { label: "AI Copilot Quickstart", href: "/docs/getting-started/copilot", group: "getting-started" },
  { label: "Agent Workflows Quickstart", href: "/docs/getting-started/agents", group: "getting-started" },
  { label: "Structured Output Quickstart", href: "/docs/getting-started/structured-output", group: "getting-started" },
  { label: "Guardrails Quickstart", href: "/docs/getting-started/guardrails", group: "getting-started" },
  { label: "Instrumentation (Getting Started)", href: "/docs/getting-started/instrumentation", group: "getting-started" },
  { label: "Instrumentation", href: "/docs/instrumentation" },
        ...
        <nav className="space-y-[2px]">
          {navItems.map((item) => (
            <Link
              ...
              className={`block rounded px-[8px] py-[6px] text-sm text-textSecondary hover:bg-surface hover:text-textPrimary transition-colors${item.group ? " pl-[20px] text-xs" : ""}`}
            >
              {item.label}
            </Link>
          ))}
